...
public partial class MainPage : ContentPage
{
    ...
    private View BuildSetupOverlay(View backgroundView)
    {
        ...
        var permissionButton = new Button { Text = AppEnvironment.T("setup.grant_permissions") };
        permissionButton.Clicked += async (_, _) => await RequestPermissionsAsync();
                ...
                new Border
                {
                    ...
                    Content = new VerticalStackLayout
                    {
                        ...
                        Children =
                        {
                            ...
                            {
                                Spacing = 12,
                                Children = { permissionButton, browseButton, configureButton }
                            }
                        }
                    }
                },
    ...
    private async System.Threading.Tasks.Task RequestPermissionsAsync()
    {
#if ANDROID
        await Permissions.RequestAsync<Permissions.StorageRead>();
        await Permissions.RequestAsync<Permissions.StorageWrite>();
        _setupStatusLabel.Text = AppEnvironment.T("setup.permission_requested");
#else
